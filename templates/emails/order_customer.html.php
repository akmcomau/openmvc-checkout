<div class="container">
	<h2><?php echo $text_receipt_for; ?> <?php echo $this->config->siteConfig()->name; ?></h2>
	<h3>
		<?php echo $text_receipt_number; ?>:
		<a href="<?php echo $this->config->getSiteURL().$this->url->getUrl('customer/Orders', 'view', [$receipt_number]); ?>"><?php echo $receipt_number; ?></a>
	</h3>
	<br />
	<div>
		<table width="100%">
